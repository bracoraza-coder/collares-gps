          ...
          return `
            <div class="bg-white rounded-xl border border-indigo-600/10 shadow-xs p-6 flex flex-col justify-between hover:border-indigo-600/25 transition-all text-center relative">
              ...
              <div class="h-24 flex flex-col justify-center space-y-1.5 pt-2">
                ...
                <a href="${p.affiliate_link}" target="_blank" rel="noopener noreferrer" class="w-full py-1.5 bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-white text-xs font-black rounded-lg shadow-xs flex items-center justify-center gap-1">
